...
const mov2000 = ["tt0180093","tt0120903","tt0249462","tt0289879","tt0209144","tt0245712","tt0160127","tt0204946","tt0175142","tt0198781","tt0454921"];
...
for(let i = 0; i < mov90.length; i++){
    fetch('http://www.omdbapi.com/?i=' + mov2000[i] + '&apikey=c46a7038').then( (data) => {
    return data.json();
    }).then((dataAsJSON) => {
    mov2000Arr[i] = dataAsJSON;
    });
};
...
const showData = (selection) => {
    ...
    selection.forEach(element => { 
      ...
      `<div>
        ...
        <p class="other-data">Year: ${element.Year}</p>results
